...
class VendorCatalogInfortisaRestDesc(models.Model):
    ...
    def _upsert_product(self, item):
        ...
        try:
            ...
            tmpl.write({"description_ecommerce": remote_html})
